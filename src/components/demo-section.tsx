...
export function DemoSection() {
  ...
  useEffect(() => {
    let mounted = true
    const chatSequence = [
      { t: 'out', html: t('demoSection.msg1'), d: 1500 },
      { t: 'in', html: t('demoSection.msg2'), d: 3500 },
      { t: 'out', html: t('demoSection.msg3'), d: 5500 },
      { t: 'in', html: t('demoSection.msg4'), d: 7500 },
      { t: 'in', html: `<div class="flex items-center gap-3 p-3 bg-[#111b21] rounded-xl border border-white/10"><div class="w-10 h-10 bg-red-500/20 rounded flex items-center justify-center text-red-500 font-bold text-[10px]">PDF</div><div class="flex-1"><div class="text-[13px] font-bold">${t('demoSection.pdfName')}</div><div class="text-[11px] text-gray-400">${t('demoSection.pdfDesc')}</div></div></div>`, d: 8500 },
      { t: 'out', html: t('demoSection.msg5'), d: 11000 },
      { t: 'in', html: t('demoSection.msg6'), d: 13500 },
    ]
          ...
          <div id="chat-container" className="relative bg-[#0b141a] border-[8px] border-[#111b21] rounded-[2.5rem] h-[650px] overflow-hidden shadow-2xl flex flex-col font-sans">
            ...
            <div className="bg-[#202c33] px-3 py-3 flex items-center gap-3 shadow-sm shadow-black/20 z-10 shrink-0">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-semibold text-[#e9edef] text-[16px] truncate leading-tight">{t('demoSection.assistantName')}</div>
                <div className="text-[13px] text-[#8696a0] font-medium mt-0.5">{t('demoSection.onlineStatus')}</div>
              </div>
            </div>
            ...
            <div className="flex-1 p-3 overflow-y-auto flex flex-col gap-2 relative bg-[#0b141a] bg-opacity-[0.93] isolate">
              ...
              <div className="text-center my-3">
                <span className="bg-[#182229] text-[#8696a0] text-[12px] font-medium px-4 py-1.5 rounded-xl shadow-sm">{t('demoSection.todayLabel')}</span>
              </div>
            ...
            <div className="bg-[#202c33] px-2 py-3 flex items-center gap-2 z-10 w-full min-h-[60px] shrink-0">
              <div className="flex-1 rounded-full bg-[#2a3942] h-[46px] flex items-center px-4">
                <span className="text-[#8696a0] text-[16px]">{t('demoSection.messagePlaceholder')}</span>
              </div>
