    ...
    <section className="py-16 relative overflow-hidden bg-transparent">
      ...
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center space-y-12">
          ...
          >
            <Award className="w-4 h-4 text-indigo-400 animate-pulse" /> {t('freeWebsiteOffer.badge')}
          </motion.div>
          ...
          <div className="space-y-6">
            <motion.h2 
              ...
              dangerouslySetInnerHTML={{
                __html: `${t('freeWebsiteOffer.title1')} <br /><span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-400 to-cyan-400">${t('freeWebsiteOffer.title2')}</span>`
              }}
            />
            ...
            <motion.p 
              ...
              dangerouslySetInnerHTML={{
                __html: `${t('freeWebsiteOffer.desc1')}<span class="px-4 py-1.5 rounded-2xl bg-indigo-200/40 dark:bg-indigo-500/20 text-indigo-700 dark:text-indigo-200 font-black relative inline-block">${t('freeWebsiteOffer.descFree')}</span>${t('freeWebsiteOffer.desc2')}`
              }}
            />
          </div>
          ...
          >
            <FeatureItem icon={<Layout className="w-8 h-8" />} label={t('freeWebsiteOffer.f1')} />
            <FeatureItem icon={<Globe className="w-8 h-8" />} label={t('freeWebsiteOffer.f2')} />
            <FeatureItem icon={<Share2 className="w-8 h-8" />} label={t('freeWebsiteOffer.f3')} />
          </motion.div>
