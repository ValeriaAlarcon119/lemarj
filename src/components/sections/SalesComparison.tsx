        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="text-2xl font-black mb-6 text-zinc-400 uppercase tracking-widest text-[10px]">{t('salesComparison.problemLabel')}</h3>
              <h4 className="text-3xl font-extrabold mb-6 leading-tight text-zinc-800 dark:text-zinc-200">{t('salesComparison.problemTitle')}</h4>
              <p className="text-muted-foreground text-lg font-medium leading-relaxed mb-8">
                {t('salesComparison.problemDesc')}
              </p>
            </div>
            <div className="space-y-4 pt-6 border-t border-zinc-200/50 dark:border-zinc-800/50">
              <div className="flex items-center gap-3 text-sm font-bold text-zinc-500"><div className="w-2 h-2 rounded-full bg-zinc-400" /> {t('salesComparison.problemList1')}</div>
              <div className="flex items-center gap-3 text-sm font-bold text-zinc-500"><div className="w-2 h-2 rounded-full bg-zinc-400" /> {t('salesComparison.problemList2')}</div>
              <div className="flex items-center gap-3 text-sm font-bold text-zinc-500"><div className="w-2 h-2 rounded-full bg-zinc-400" /> {t('salesComparison.problemList3')}</div>
            </div>
          </motion.div>
            ...
            <div className="bg-white dark:bg-zinc-950 rounded-[3.4rem] p-8 md:p-10 h-full w-full flex flex-col space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4 pb-2">
                <div className="p-4 rounded-2xl bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-100 dark:border-indigo-500/10 flex flex-col items-center text-center gap-3 group/item hover:bg-indigo-500 hover:text-white transition-all duration-500">
                  ...
                  <span className="text-[11px] font-black uppercase text-indigo-600 dark:text-indigo-400 group-hover/item:text-white">{t('salesComparison.solutionFeature1')}</span>
                </div>
                <div className="p-4 rounded-2xl bg-cyan-50 dark:bg-cyan-950/30 border border-cyan-100 dark:border-cyan-500/10 flex flex-col items-center text-center gap-3 group/item hover:bg-cyan-500 hover:text-white transition-all duration-500">
                  ...
                  <span className="text-[11px] font-black uppercase text-cyan-600 dark:text-cyan-400 group-hover/item:text-white">{t('salesComparison.solutionFeature2')}</span>
                </div>
                <div className="p-4 rounded-2xl bg-purple-50 dark:bg-purple-950/30 border border-purple-100 dark:border-purple-500/10 flex flex-col items-center text-center gap-3 col-span-2 group/item hover:bg-purple-500 hover:text-white transition-all duration-500">
                  ...
                  <span className="text-[11px] font-black uppercase tracking-widest text-purple-600 dark:text-purple-400 group-hover/item:text-white">{t('salesComparison.solutionFeature3')}</span>
                </div>
              </div>
            </div>
          </motion.div>
