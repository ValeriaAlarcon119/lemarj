    ...
    <section className="py-16 relative overflow-hidden bg-transparent">
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 space-y-4">
          ...
          >
            <Zap className="w-3 h-3 animate-pulse" /> {t('expertTips.badge')}
          </motion.div>
          ...
          <motion.h2 
            ...
            dangerouslySetInnerHTML={{
              __html: `${t('expertTips.title1')}<br /><span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-cyan-500">${t('expertTips.title2')}</span>`
            }}
          />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
          <TipCard 
            ...
            title={t('expertTips.tips.design.title')} 
            desc={t('expertTips.tips.design.desc')} 
            delay={0.1}
          />
          <TipCard 
            icon={<Landmark className="w-6 h-6" />} 
            title={t('expertTips.tips.finance.title')} 
            desc={t('expertTips.tips.finance.desc')} 
            delay={0.2}
          />
          <TipCard 
            icon={<TrendingUp className="w-6 h-6" />} 
            title={t('expertTips.tips.marketing.title')} 
            desc={t('expertTips.tips.marketing.desc')} 
            delay={0.3}
          />
          <TipCard 
            icon={<Share2 className="w-6 h-6" />} 
            title={t('expertTips.tips.visibility.title')} 
            desc={t('expertTips.tips.visibility.desc')} 
            delay={0.4}
          />
        </div>
      </div>
